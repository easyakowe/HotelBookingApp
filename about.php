  ...
  <div class="about-wthree" id="about">
      <div class="container">
           <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Intercon Hotel and Suites</h3> 
               <p class="about-para-w3ls">This is the best place to make your bookings and reservations more conviniently, and it is the best arena to welcome your visitors, and have fun. INTERCON HOTEL SYSTEM was developed following system development stages
                   for smooth running and management of our hotel. Intercon Hotel offers accommodation, meals, additional facilities and other services.
                   Accommodation services and facilities available includes: Breakfast; Lunch, dinner, tea, Laundry, Ironing, transport and room service.</p>
               <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                    <div class="w3l-slider-img">
                      ...
                      <p>Because your convinience and first class comfort is our topmost priority </p>
                    </div>
              </div>
        <div class="clearfix"> </div>
    </div>
