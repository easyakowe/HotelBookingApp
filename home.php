...
<?php
	...
	if (isset($_SESSION)) {
	echo "<div id=\"Reg-login\" style=\"display:none\"></div>";
	}
	...
	<div class="w3_navigation">
		<div class="container">
			<nav class="navbar navbar-default">
				...
				<div id="Reg-login" style="text-align: right; color: white;">
					<a style="color: yellow;" href="signupForm.php" id="reg">Register </a>or<a style="color: yellow;" href="index.php" id="lgin"> Login</a>
				</div>

				<!--Changing to welcome message after Signup or Login-->
				<div style="display: none; color:#ffcc00;" id="welcome-message">
			<a id="hi" style="color: yellow;" href="#"><?php echo "Hi, "; echo $_SESSION['u_name'];?></a>
			<br>
			<div style="" id="bloc1" class="agileits_w3layouts_more1 menu__item">
			<a id="logout" style="text-align: right;" href="#" class="menu__link" data-toggle="modal" data-target="#myModal1">Logout</a>
				</div>
				</div> 
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<p>Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Intercon Hotel one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
									</div>
								</div>
							</div>
						</div>
...
<!-- The former position of the Availability form -->
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Intercon Hotel</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>This service enables you to pay after you have experienced our first class Hotel rooms and amenities. We are confident beyond any doubt that you will be thrilled.</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>Our restaurant is available 24/7 for your meals which include breakfast, brunch, lunch and dinner. Any time, any day. Enjoy</p>
...
<!-- /contact -->
			<!-- <div class="copy">
		        <p>© 2017 Intercon Hotel and Suites . All Rights Reserved | Design by <a href="http://w3layouts.com/">W3layouts</a> </p>
		    </div> -->
<!--/footer -->
<!-- js -->
<script type="text/javascript" src="js/jquery-2.1.4.min.js"></script>
